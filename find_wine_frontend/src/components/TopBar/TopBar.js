...
class TopBar extends Component {
  ...
  checkCurrentUser = () => {
    ...
    if (this.props.current_user.user_details) {
      return (
        <>
          <Nav.Link className="profile" href="/users/1">
            HEY, {this.props.current_user.user_details.name.toUpperCase()}
          </Nav.Link>
          <Nav.Link
      ...
      return (
        <Nav.Link className="profile" href="/login">
          LOG IN
        </Nav.Link>
      );
    }
  ...
  checkCart = () => {
    return window.location.pathname === "/cart" ? null : (
      <Link to={`/cart`} className="cart" style={myStyles}>
        <i className="shopping bag large icon"></i>
